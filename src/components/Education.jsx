                    ...
                    <div className="relative pl-8 md:pl-12 group">
                        ...
                        <div className="bg-white/5 p-6 rounded-xl border border-white/10 hover:border-pink-500/30 transition-colors">
                            <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-2">
                                <h3 className="text-xl font-bold text-white flex items-center gap-2"><Award size={30} /> IITM Pravartak | Training and Internship Certification in Full Stack Development with DSA & GenAI</h3>
